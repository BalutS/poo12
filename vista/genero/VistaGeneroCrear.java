...
import org.unimag.controlador.GenereroControladorGrabar;
...
public class VistaGeneroCrear extends StackPane {
    ...
    private void crearFormulario() {
        ...
        cbmEstadoGenero.getItems().addAll(
    ...
    private Boolean formularioCompleto() {
        ...
        if (cbmEstadoGenero.getSelectionModel().getSelectedIndex() == 0) {
            Mensaje.mostrar(Alert.AlertType.WARNING, null,
                    "UHmmmmmm", "Escoge un estado a lo bien");
    ...
    private void guardarElGenero() {
        if (formularioCompleto()) {
            ...
            if (GenereroControladorGrabar.crearGenero(dto)) {
